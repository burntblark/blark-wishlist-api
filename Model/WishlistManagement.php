...
namespace Blark\Wishlist\Model;

use Blark\Wishlist\Api\WishlistManagementInterface;
...
class WishlistManagement implements WishlistManagementInterface
{
    ...
    public function addToWishlist($customerId, $productId)
    {
        if ($productId == null) {
            throw new LocalizedException(__
                ('Invalid product, Please select a valid product from the catalog'));
        }
        try {
    ...
    /**
     * Delete wishlist item for customer's wishlist
     *
     * @param int $customerId
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function removeFromWishlist($customerId, $wishlistItemId)
    {
        ...
        if (!$item->getId()) {
            throw new \Magento\Framework\Exception\NoSuchEntityException(
                __('The requested Wish List Item doesn\'t exist in your list.')
            );
        }
